...
enum ERRORS{
    ...
    BECOMES_MUST_FOLLOW_IDENT_IN_STATEMENT = 29,
	PROC_MUST_HAVE_PARAMS = 30,
	IDENT_EXPECTED_AS_PARAM = 31,
	BAD_PROC_DECLARATION = 32,
	MISSING_PARAM_LIST = 33,
	BAD_CALL_FORMATTING = 34
};
